package com.example.flagapplication.alarmremind;
...
public class AlarmAlertBroadcastReceiver extends BroadcastReceiver {
    ...
    private boolean isVibrater = false;
    @Override
    ...
    private void showAlarmDialog(Context context, AlarmBean bean){
        ...
        builder.setTitle("The time of"+bean.getTitle()+"which you made has come for you!")
