...
public class Fragment3 extends BaseFragment{
    ...
    private void generateTempoData() {
        ...
        Axis tempoAxis = new Axis(axisValues).setName("Flag amounts").setHasLines(true).setMaxLabelChars(4)
        ...
        tempoData.setAxisYRight(new Axis().setName("Consumed time").setMaxLabelChars(3)
    ...
    private void generatePieData() {
        ...
        if (hasCenterText1) {
            pieData.setCenterText1("Comment");
        ...
        if (hasCenterText2) {
            pieData.setCenterText2("A waste of time");
